...
- (void)init_UI {
    ...
    reasonLabel.sd_layout.topSpaceToView(backView,10).leftSpaceToView(backView,10).widthIs(85).heightIs(40);
    ...
    _moneyLabel.sd_layout.topSpaceToView(reasonLabel,20).leftSpaceToView(backView,10).widthIs(85).heightIs(40);
    ...
    view1.sd_layout.topSpaceToView(_moneyLabel,10).leftSpaceToView(self,0).rightSpaceToView(self,0).widthIs(KscreenWidth).heightIs(1);
    
    UILabel *phoneLabel = [[UILabel alloc] init];
    phoneLabel.text = @"手机号码：";
    [backView addSubview:phoneLabel];
    phoneLabel.sd_layout.topSpaceToView(_moneyLabel,20).leftSpaceToView(backView,10).widthIs(85).heightIs(40);
    
    UITextField *_phoneTF = [[UITextField alloc] init];
    _phoneTF.placeholder = @"请输入接收手机号码";
    [backView addSubview:_phoneTF];
    _phoneTF.sd_layout.topSpaceToView(_moneyTF,20).leftSpaceToView(phoneLabel,0).widthIs(180).heightIs(40);
    ...
    confirmBtn.sd_layout.topSpaceToView(backView,90).leftSpaceToView(self,20).widthIs(KscreenWidth-40).heightRatioToView(self,0.08);
