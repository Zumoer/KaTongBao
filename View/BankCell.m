...
//        }
        ...
        if ([BusiIntf curPayOrder].BankName == nil || [[BusiIntf curPayOrder].BankName isEqualToString:@""]) {
            bankLabel.text = @"招商银行";
        }
        ...
        bankLabel.sd_layout.topSpaceToView(self.contentView,12).leftSpaceToView(self.contentView,20).widthIs(60).heightIs(20);
