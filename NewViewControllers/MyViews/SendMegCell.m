...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        [self.sendButton setTitle:@"获取" forState:UIControlStateNormal];
        ...
        _button.sd_layout.rightSpaceToView(self.contentView,26.5).topSpaceToView(self.contentView,7).widthIs(90).heightIs(26.5);
        self.reSendBtn.sd_layout.rightSpaceToView(self.contentView,10).topSpaceToView(self.contentView,7).widthIs(120).heightIs(26.5);
        self.sendButton.sd_layout.rightSpaceToView(self.contentView,26.5).topSpaceToView(self.contentView,7).widthIs(90).heightIs(26.5);
    }
    return self;
}
