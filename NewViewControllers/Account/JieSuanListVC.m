...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (cell == nil) {
        ...
        JieSuanCell *Cell = [[JieSuanCell alloc] init];
        Cell.TimeLable.text = model.settleReqTime;
        Cell.AmountLable.text = model.amount;
        Cell.TypeLable.text = model.settleStatusName;
