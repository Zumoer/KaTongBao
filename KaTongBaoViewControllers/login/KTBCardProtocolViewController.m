...
- (void)viewDidLoad {
    ...
    if (self.tag == 1) {
        ScrollView.frame = CGRectMake(0, -30, KscreenWidth, KscreenHeight);
        ...
        [attributeStr addAttribute:NSFontAttributeName value:[UIFont fontWithName:@"Helvetica-Bold" size:15] range:NSMakeRange(21, 5)];
        [attributeStr addAttribute:NSFontAttributeName value:[UIFont fontWithName:@"Helvetica-Bold" size:13] range:NSMakeRange(29, 4)];
        [attributeStr addAttribute:NSFontAttributeName value:[UIFont fontWithName:@"Helvetica-Bold" size:13] range:NSMakeRange(142, 6)];
