...
@interface JXJieSuanViewController ()

@end

@implementation JXJieSuanViewController {
...
- (void)ToJieSuan {
    ...
    JXJieSuanListViewController *list = [[JXJieSuanListViewController alloc] init];
