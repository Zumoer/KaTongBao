...
- (instancetype)init {
    if ((self = [super initWithFrame:CGRectMake(0, 0, Size, Size)])) {
        ...
        UIImageView *FirstImg = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 70, 70)];
        FirstImg.image = [UIImage imageNamed:@"l_p1@2x.jpg"];
        FirstImg.contentScaleFactor = 0.5;
        FirstImg.center = self.imageView.center;
        [self.imageView addSubview:FirstImg];
        
        UIImageView *SecondImg = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 54.55, 54.55)];
        SecondImg.center = FirstImg.center;
        SecondImg.backgroundColor = [UIColor clearColor];
        SecondImg.image = [UIImage imageNamed:@"l_p2@2x.jpg"];
        SecondImg.layer.cornerRadius = 27.27;
        SecondImg.layer.masksToBounds = YES;
        [self.imageView addSubview:SecondImg];
        
        UIImageView *ThirdImg = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 36.03, 36.03)];
        ThirdImg.center = SecondImg.center;
        ThirdImg.backgroundColor = [UIColor clearColor];
        ThirdImg.layer.cornerRadius = 18.2;
        ThirdImg.layer.masksToBounds = YES;
        ThirdImg.image = [UIImage imageNamed:@"l_p3@2x.jpg"];
        [self.imageView addSubview:ThirdImg];
        
        UILabel *LoadLab = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 30, 10)];
        LoadLab.text = @"加载中";
        LoadLab.textAlignment = NSTextAlignmentCenter;
        LoadLab.textColor = [UIColor blackColor];
        LoadLab.font = [UIFont systemFontOfSize:7];
        LoadLab.center = SecondImg.center;
        [self.imageView addSubview:LoadLab];
        
        FirstImg.layer.contentsScale = 0.5;
        SecondImg.layer.contentsScale = 0.5;
        ThirdImg.layer.contentsScale = 0.5;
        LoadLab.layer.contentsScale = 0.5;
        ...
        [ThirdImg.layer addAnimation:rotationAnimation forKey:@"rotationAnimation"];
        [FirstImg.layer addAnimation:rotationAnimation forKey:@"rotationAnimation"];
        rotationAnimation.toValue = [NSNumber numberWithFloat:-M_PI * 2];
        [SecondImg.layer addAnimation:rotationAnimation forKey:@"rotationAnimation"];
