...
// del by chendm 2012-5-31 原来在主线程里完成，现在在自己的任务线程里完�?//        [self performSelectorOnMainThread:@selector(reportFinished) withObject:nil waitUntilDone:[NSThread isMainThread]];
