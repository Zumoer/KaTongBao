...
- (void)initControlBtn {
    ...
    UIButton *cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(16, self.view.frame.size.height - 114.0f, 100, 40)];
    ...
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.view.frame.size.width - 116.0f, self.view.frame.size.height - 114.0f, 100, 40)];
