...
{
    _date = date;
    [_monthLabel setText:[NSString stringWithFormat:@"%.2ld-%li",[self month:date],[self year:date]]];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSInteger i = indexPath.row;
    day = i - firstWeekday + 1;
     NSString *str1 = [NSString stringWithFormat:@"%ld",[comp month]];
    if (str1.length == 1) {
        NSString *string = [NSString stringWithFormat:@"0%ld",[comp month]];
        NSString *str= [NSString stringWithFormat:@"%ld%@%ld000000",[comp year],string,day];
        ...
        NSString *str= [NSString stringWithFormat:@"%ld%ld%ld000000",[comp year],[comp month],day];
        [dataArray addObject:str];
        if (dataArray.count == 2) {
        ...
        self.calendarBlock(dataArray);
    }
//    UICollectionViewCell *selectCell = [collectionView cellForItemAtIndexPath:_selectIndexPath];
